				...
				<input type="hidden" name="reserveNo" value="${reserveNo}">
					...
					<div class="form-group">
						...
						<div class="star-rating" id="locationRating">
							...
							<label class="star" for="location5" title="5 stars"></label> 
							<input type="radio" id="location4" name="location" value="4"> 
							<label class="star" for="location4" title="4 stars"></label> 
							<input type="radio" id="location3" name="location" value="3"> 
							<label class="star" for="location3" title="3 stars"></label> 
							<input type="radio" id="location2" name="location" value="2"> 
							<label class="star" for="location2" title="2 stars"></label> 
							<input type="radio" id="location1" name="location" value="1"> 
							<label class="star" for="location1" title="1 star"></label>
						</div>
					...
					<div class="form-group">
						...
						<div class="star-rating" id="valueRating">
							...
							<label class="star" for="value5" title="5 stars"></label> 
							<input type="radio" id="value4" name="accuracy" value="4"> 
							<label class="star" for="value4" title="4 stars"></label> 
							<input type="radio" id="value3" name="accuracy" value="3"> 
							<label class="star" for="value3" title="3 stars"></label> 
							<input type="radio" id="location2" name="location" value="2"> 
							<label class="star" for="location2" title="2 stars"></label> 
							<input type="radio" id="location1" name="location" value="1"> 
							<label class="star" for="location1" title="1 star"></label>
